...
/// 1. Register page
/// 2. Payment page
class CheckoutScreen extends RiveBlocStatefulWidget {
  const CheckoutScreen({super.key});

  @override
  RiveBlocStatefulState<CheckoutScreen> createState() => _CheckoutScreenState();
}

class _CheckoutScreenState extends RiveBlocStatefulState<CheckoutScreen> {
