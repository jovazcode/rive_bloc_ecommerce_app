...
class PaymentPage extends RiveBlocWidget {
  const PaymentPage({super.key});

  @override
  Widget build(context, ref) {
    ref.listen(cartTotalProvider, (_, __, cartTotal) {
    ...
    final cartStreamBloc = ref.watch(cartProvider);
    final cartValue = cartStreamBloc.state;
