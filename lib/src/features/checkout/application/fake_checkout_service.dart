...
//   );
// }
final checkoutServiceProvider = RiveBlocProvider.value<
    ValueCubit<FakeCheckoutService?>,
    FakeCheckoutService?>(FakeCheckoutServiceValueCubit.new);

class FakeCheckoutServiceValueCubit extends ValueCubit<FakeCheckoutService?> {
  FakeCheckoutServiceValueCubit()
      : super(null,
            build: (ref, args) => FakeCheckoutService(
                  ...
                  fakeProducsRepository: ref.read(productsRepositoryProvider),
                  currentDateBuilder: () => DateTime.now(),
                ));
}
