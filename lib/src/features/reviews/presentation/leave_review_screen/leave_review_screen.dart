  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ResponsiveCenter(
        ...
        child: RiveBlocBuilder(
          builder: (context, ref, child) {
            final reviewValue = ref
                .watch(userReviewFutureProvider(ref, Args({'id': productId})))
                .state;
...
class LeaveReviewForm extends RiveBlocStatefulWidget {
  ...
  @override
  RiveBlocStatefulState<LeaveReviewForm> createState() =>
      _LeaveReviewFormState();
}

class _LeaveReviewFormState extends RiveBlocStatefulState<LeaveReviewForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.watch(leaveReviewControllerProvider).state;
    return Column(
      ...
      children: [
        ...
        PrimaryButton(
          ...
          onPressed: state.isLoading || _rating == 0
              ? null
              : () => ref.read(leaveReviewControllerProvider).submitReview(
