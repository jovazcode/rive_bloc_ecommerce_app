...
class ProductsSearchTextField extends RiveBlocStatefulWidget {
  const ProductsSearchTextField({super.key});

  @override
  RiveBlocStatefulState<ProductsSearchTextField> createState() =>
      _ProductsSearchTextFieldState();
}

class _ProductsSearchTextFieldState
    extends RiveBlocStatefulState<ProductsSearchTextField> {
    ...
    return ValueListenableBuilder<TextEditingValue>(
      ...
      builder: (context, value, _) {
        return TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: value.text.isNotEmpty
                ? IconButton(
                    onPressed: () {
                      _controller.clear();
                      ref.read(productsSearchQueryStateProvider).state = '';
                    },
          ...
          onChanged: (text) =>
              ref.read(productsSearchQueryStateProvider).state = text,
        );
      },
    );
  }
