...
class EmailPasswordSignInContents extends RiveBlocStatefulWidget {
  ...
  final EmailPasswordSignInFormType formType;
  @override
  RiveBlocStatefulState<EmailPasswordSignInContents> createState() =>
      _EmailPasswordSignInContentsState();
}

class _EmailPasswordSignInContentsState
    extends RiveBlocStatefulState<EmailPasswordSignInContents>
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.watch(emailPasswordSignInControllerProvider).state;
