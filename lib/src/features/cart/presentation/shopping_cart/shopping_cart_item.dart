...
class ShoppingCartItem extends RiveBlocWidget {
  ...
  Widget build(context, ref) {
    final productValue =
        ref.watch(productProvider(ref, Args({'id': item.productId}))).state;
...
class ShoppingCartItemContents extends RiveBlocWidget {
...
class EditOrRemoveItemWidget extends RiveBlocWidget {
  ...
  @override
  Widget build(context, ref) {
    final state = ref.watch(shoppingCartScreenControllerProvider).state;
    return Row(
