...
class CartSyncService {
  ...
  void _init() {
    ref.listen(authStateChangesProvider, (bloc, previous, next) {
  ...
  Future<void> _moveItemsToRemoteCart(UserID uid) async {
    try {
      ...
      final localCartRepository =
          ref.read<LocalCartRepository, LocalCartRepository>(
...
// }
final cartSyncServiceProvider = RiveBlocProvider.async(
    () => AsyncCubit((ref, args) => CartSyncService(ref)));
